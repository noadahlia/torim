...
CREATE INDEX IF NOT EXISTS idx_reservations_professional_time ON reservations(professional_id, start_time, end_time) WHERE status NOT IN ('CANCELLED_BY_CLIENT', 'CANCELLED_BY_PROFESSIONAL', 'NO_SHOW');
